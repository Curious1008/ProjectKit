 ...
 *
 * Options:
 *   --source   Source SVG file path (default: assets/logo/projectkit-logo.svg)
...
const DEFAULT_SOURCE = path.join(ROOT_DIR, 'assets/logo/projectkit-logo.svg');
...
const ICON_SIZES = [
  ...
  { name: 'projectkit-logo.png', size: 512, description: 'ProjectKit Logo' },
];
