...
export class UsersSeederService {
  ...
  async seed() {
    ...
    const usersData = [
      ...
      {
        email: 'jane.smith@projectkit.com',
        username: 'janesmith',
        firstName: 'Jane',
        lastName: 'Smith',
        role: Role.MANAGER,
      ...
      {
        email: 'mike.wilson@projectkit.com',
        username: 'mikewilson',
        firstName: 'Mike',
        lastName: 'Wilson',
        role: Role.MEMBER,
      ...
      {
        email: 'sarah.jones@projectkit.com',
        username: 'sarahjones',
        firstName: 'Sarah',
        lastName: 'Jones',
        role: Role.MEMBER,
      ...
      {
        email: 'alex.brown@projectkit.com',
        username: 'alexbrown',
        firstName: 'Alex',
        lastName: 'Brown',
        role: Role.MEMBER,
      ...
      {
        email: 'emma.davis@projectkit.com',
        username: 'emmadavis',
        firstName: 'Emma',
        lastName: 'Davis',
        role: Role.VIEWER,
      ...
      {
        email: 'tom.garcia@projectkit.com',
        username: 'tomgarcia',
        firstName: 'Tom',
        lastName: 'Garcia',
        role: Role.MEMBER,
